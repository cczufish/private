...
package com.hiwifi.downloadproviders;
...
import com.hiwifi.downloadproviders.downloads.Downloads;
...
public class DownloadManager {
	...
	public static class Request {
		 ...
		 * it's in progress.
		 */
		public static final int VISIBILITY_VISIBLE = Downloads.VISIBILITY_VISIBLE;

		/**
		 * This download is visible and shows in the notifications while in
		 * progress and after completion.
		 */
		public static final int VISIBILITY_VISIBLE_NOTIFY_COMPLETED = Downloads.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;

		/**
		 * This download doesn't show in the UI or in the notifications.
		 */
		public static final int VISIBILITY_HIDDEN = Downloads.VISIBILITY_HIDDEN;
		...
		/**
		 * Control whether a system notification is posted by the download
		 * manager while this download is running or when it is completed. If
		 * enabled, the download manager posts notifications about downloads
		 * through the system {@link android.app.NotificationManager}. By
		 * default, a notification is shown only when the download is in
		 * progress.
		 * <p>
