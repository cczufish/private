...
public class OpenHelper {
    ...
    public static Intent buildViewIntent(Context context, long id) {
        final DownloadManager downManager = new DownloadManager(context.getContentResolver(), context.getPackageName());
//        downManager.setAccessAllDownloads(true);
        ...
        try {
            ...
            String mimeType = getCursorString(cursor, DownloadManager.COLUMN_MEDIA_TYPE);
