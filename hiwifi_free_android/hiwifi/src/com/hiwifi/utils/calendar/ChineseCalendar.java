...
//======   传入   offset   传回干支,   0=甲子
  ...
  private static String getChineseTwentyFourDay(Date date1){
        ...
        for (int i = 1; i <= 24; i++){
            ...
            //对时间进行格式化字符串比较
//            System.out.println("========="+formatData(calendarMin.getTime(), "yyyy-MM-dd hh:mm").trim()+"    :   "+formatData(calendarDate1.getTime(), "yyyy-MM-dd hh:mm").trim());
//            System.out.println("time ==="+calendarDate1.getTime()+"-======time2 ====="+calendarDate1.getTime());
            ...
            if(calendarDate1.getTime().getTime()<calendarMin.getTime().getTime()){
            	tempStr = SolarTerm[i - 1];
            	break;
            }
        }
