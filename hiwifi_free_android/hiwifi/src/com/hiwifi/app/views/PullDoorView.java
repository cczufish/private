...
import com.hiwifi.app.receiver.GetSMSReceiver.GetSmsListener;
...
public class PullDoorView extends RelativeLayout {
	...
	private static ClickListener listener = null;
	
	
	public static void setListener(ClickListener listener) {
		PullDoorView.listener = listener;
	}
...
//		addView(mImgView);
	...
	public void startBounceAnim(int startY, int dy, int duration) {
		...
		invalidate();
		if (mScreenHeigh == dy && listener != null) {
			listener.skip();
		}
	}
