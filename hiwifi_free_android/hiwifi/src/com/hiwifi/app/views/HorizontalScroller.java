...
public class HorizontalScroller extends ViewGroup
{
    ...
    public HorizontalScroller(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HorizontalScroller);
        pageWidthSpec = a.getDimensionPixelSize(R.styleable.HorizontalScroller_pageWidth, SPEC_UNDEFINED);
        a.recycle();
     ...
     */
    private void init() {
    	Interpolator acc=new DecelerateInterpolator();
        mScroller = new Scroller(getContext(),acc);
        mCurrentPage = 0;
     ...
     * @param whichPage
     * @return 某页的位置-每页距离屏幕边缘的距离（即某页距离屏幕右边的距离）
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //每页的宽度取屏幕宽度和指定宽度两者之间的小者，这就意味着每页的宽度不能超过屏幕的宽度
