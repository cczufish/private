...
public class AsyncHttpClient {
	...
	public AsyncHttpClient(SchemeRegistry schemeRegistry) {
		...
		HttpProtocolParams.setUserAgent(httpParams,
				String.format("android_hiwififree_V" + Gl.versionName));
	...
	/**
	 * add common header for all request
	 * 
	 * @param request
	 */
	private void setHeader(HttpRequest request) {
		...
		if (!TextUtils.isEmpty(clientModel)) {
			...
			clientHeaderMap.remove("clientmodel");
			request.removeHeaders("clientmodel");
		}
//		if (ReleaseConstant.ISDEBUG) {
//			for (Header header : request.getAllHeaders()) {
//				HWFLog.e("debug", header.toString());
//			}
//		}
	}
