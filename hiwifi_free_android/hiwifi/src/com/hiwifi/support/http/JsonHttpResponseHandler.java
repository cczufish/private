...
public class JsonHttpResponseHandler extends TextHttpResponseHandler {
    ...
    /**
     * request failed,timeout callback 
     * 
     */
    @Override
                ...
                public void run() {
                    try {
                        ...
                        postRunnable(new Runnable() {
                            @Override
                            public void run() {
                            	 onFailure(statusCode, headers, responseBytes.toString(), throwable);
//                                onFailure(statusCode, headers, ex, (JSONObject) null);
                            }
                        });
		...
		parser.run();
            ...
            Log.v(LOG_TAG, "response body is null, calling onFailure(statusCode, headers, throwable, JSONObject)");
            Log.v(LOG_TAG, "url is:"+this.getRequestURI());
