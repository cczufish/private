...
typedef void (^ChartViewText) (LCLineChartDataItem *anItem, NSString *aText);
...
@property (readonly) NSInteger xIndex;
@property (readonly) BOOL dateFlag; // YES:today NO:yesterday
...
@property float maxPoint;
@property NSInteger maxPointIndex;
@property NSString *maxPointText;
...
{
    void (^_chartItemText) (LCLineChartDataItem *anItem, NSString *aText);
}
